...
<div class="copyright_section">
  <div class="container">
    <p class="copyright_text">Contactos:<a href="#"></a></p>
    <ul class="copyright_text" style="text-align: center; padding-bottom: 3%;">
      <li>Celular: 3005993821</li>
      <li>Correo: <a href="mailto:felipe.291105@gmail.com" style="color: grey;" onmouseover="this.style.color='brown'" onmouseout="this.style.color='grey'">felipe.291105@gmail.com</a></li>
      ...
      <div class="modal-body m-3">
        <div class="row">
          <div class="col-md-12" id="frmLogin">
            ...
            <a href="#" id="btnRegister">¿Todavia no tienes una cuenta?</a> <br>
            <a href="#" id="btnPassword">¿Olvidaste la Contraseña?</a>
          ...
          <div class="col-md-12 d-none" id="frmPassword">
            <div class="form-group mb-3">
              <label for="correoRecuperacion"><i class="fas fa-envelope"></i> Correo</label>
              <input id="correoRecuperacion" class="form-control" type="text" name="correoRecuperacion" placeholder="Correo Electrónico">
            </div>
            <a href="#" id="btnBackToLogin">Volver al login</a>
            <div class="float-right">
              <button class="btn btn-primary" type="button" id="recuperar">Recuperar Contraseña</button>
            </div>
          </div>
        </div>
      </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    btnPassword.addEventListener('click', function() {
      frmLogin.classList.add('d-none');
      frmPassword.classList.remove('d-none');
    });

    btnBackToLogin.addEventListener('click', function() {
      frmPassword.classList.add('d-none');
      frmLogin.classList.remove('d-none');
    });
    ...
    document.getElementById('recuperar').addEventListener('click', function() {
      ...
      fetch('clientes/solicitarRecuperacion', {
          method: 'POST',
          headers: {
