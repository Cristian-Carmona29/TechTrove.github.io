...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>assets/principal/css/style2.css">
   ...
   <!-- fevicon -->
   <link rel="icon" href="<?php echo BASE_URL; ?>assets/images/empresa/icono2.jpg" type="image/gif" />
   ...
   <script src="https://kit.fontawesome.com/70718c57df.js" crossorigin="anonymous"></script>
   ...
   <div class="header_section">
      <div class="container-fluid">
         <div class="containt_main">
            ...
            <span class="toggle_icon" onclick="openNav()"><i class="fa-solid fa-bars-staggered"></i></span>
            <div class="dropdown">
            ...
            <div class="main">
               ...
               <div class="input-group">
                  ...
                  <div class="input-group-append">
                     <button class="btn btn-secondary" type="button" style="background-color: #f26522; border-color:#f26522; border-radius: 0px 0px 15px 0px">
                        <i class="fa fa-search"></i>
                     </button>
                  </div>
               </div>
               <div class="position-absolute row d-flex flex-column" id="resultBusqueda" style="z-index: 99999;"></div>
            </div>
